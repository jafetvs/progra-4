  ...
  protected void processRequest(HttpServletRequest request, 
    ...
    void updateModel(HttpServletRequest request){
       Model model= (Model) request.getAttribute("model");
        ...
        model.getCurrent().setNumeroPoliza(request.getParameter("numeroFld"));
   }    
    ...
    public String showAction(HttpServletRequest request) {
        ...
        try {        
            model.setCurrent(service.polizaFind(model.getCurrent().getNumeroPoliza()));
            if (!(model.getCurrent().getCliente().getCedula().equals(usuario.getCedula()))) 
                throw new Exception("Esta Poliza no le pertenece al cliente");
